...
public class EntryController {
    ...
    @Autowired
    public EntryController(TeleconEntriesService teleconService, AuthenticationToken authenticationToken, TokenService tokenService, AssignmentService assignmentService) {
